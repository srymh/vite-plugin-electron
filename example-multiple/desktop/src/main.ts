...
const PRODUCTION_RENDERER_DIST_PATH = app.isPackaged
  ? '../web/dist/'
  : '../../web/dist/'
const PRODUCTION_RENDERER_INDEX_URL = new URL(
  `${PRODUCTION_RENDERER_DIST_PATH}index.html`,
  import.meta.url,
)
const PRODUCTION_RENDERER_ROOT_URL = new URL(
  PRODUCTION_RENDERER_DIST_PATH,
  import.meta.url,
)
