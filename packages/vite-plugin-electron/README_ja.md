...
> [English README](https://github.com/srymh/vite-plugin-electron/blob/main/packages/vite-plugin-electron/README.md)
...
詳細なドキュメントは [docs サイト](https://srymh.github.io/vite-plugin-electron/) を参照してください。
